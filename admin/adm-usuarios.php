...
<tr><th class="title">Nuevo Usuario</th></tr>
               <tr><th class="message">Guardando usuario...</th></tr>
<tr><td>Nombre de Usuario</td></tr>
<tr><td><input type="text" name="User" maxlength="20" onKeyPress="if(!((event.keyCode>96 && event.keyCode<123) || (event.keyCode>64 && event.keyCode<91) || (event.keyCode==46 || event.keyCode==45 || event.keyCode==95) || (event.keyCode>47 && event.keyCode<58))) event.returnValue=false;" /></td></tr>
<tr><td>Contraseña</td></tr>
<tr><td><input type="text" name="Pass" maxlength="20" /></td></tr>
...
<div>
            <table class="tbl-usr-log"><tbody><tr><th class="message" style="">panel de mensajes</th></tr></tbody></table>
