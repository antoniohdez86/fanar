                    	...
                    	<table class="tbl-reporte" border="0" cellspacing="1">
                         	<tbody class="tbHead">
                              	<tr>
                                        ...
                                        <th>ETAPA MAXIMA</th>
                                        <th>PROBLEMATICA</th>
                                        <th>COMPROMISOS Y SITUACION DE CUMPLIMIENTO</th>
                                   </tr>
                           </tbody>
                         	<tbody class="tbBody">
                              	<tr>
                                        ...
                                        <td>ATLALCO Y TEPEOLOL II</td>
                                        <td>INCORPORADO AL FANAR EL 11/NOC/2012</td>
                                        <td>SIN PROBLEMATICA</td>
                                        <td>CERTIFICACION POR PARTE DEL RAN</td>
                                   </tr>
                              	<tr>
	                                   	 <td>1.-</td>
                                        <td>HUEJUTLA DE REYES</td>
