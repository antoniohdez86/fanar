...
<link type="text/css"  href="../js/jquery/themes/jquery-ui-1.8.20.custom.css" rel="stylesheet" />
...
<td colspan="3">
                              <input type="text" value="" class="emp" style="width:70%;" readonly>
...
<legend>Datos de la actividad</legend>
                     ...
                     <tbody class="tbBody">
                        <tr>
                           <td colspan="3" class="message" style="" align="center">Cargando datos de seguimiento...</td>
                           </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td><input type="text" size="10" readonly  id="dateSeg"></td>
                           </tr>
                        <tr>
