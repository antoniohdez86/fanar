...
<div class="dialog1" id="dialog1">
   <div style="display:block; opacity:0.2; width:100%; height:100%;"></div>
<form name="frmNucleo">
...
<tr><td class="input"><input type="text" name="id" maxlength="6" onKeyPress="if(event.keyCode<45 || event.keyCode>57) event.returnValue=false;" /></td></tr>
<tr><td class="label">Nombre para el Nucleo Agrario</td></tr>
<tr><td class="input"><input type="text" name="nombre" maxlength="60" onKeyPress="if(!((event.keyCode>96 && event.keyCode<123) || (event.keyCode>64 && event.keyCode<91) || (event.keyCode==241 || event.keyCode==209 || event.keyCode==32))) event.returnValue=false;" /></td></tr>
...
<tr><td class="input"><input type="text" name="superf" maxlength="15" onKeyPress="if(event.keyCode<48 || event.keyCode>57) event.returnValue=false;" /></td></tr>
