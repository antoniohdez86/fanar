	...
	<div class="main-doc">
		...
		<div class="body">
			...
			<div class="colDer">
				...
				<p class="parrafo1">
					Bienvenido al Sistema FANAR.&nbsp;&nbsp;<span style="font-style:normal; color:#0C0; font-family:Arial, Helvetica, sans-serif; background-color:#fff; padding:5px; "><?php echo $_SESSION['usuario']->empleado; ?></span><br><br>
