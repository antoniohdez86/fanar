	     	...
	     	<table>
     	     	<tbody>
          	     	<tr><th>Nuevo Municipio</th></tr>
                         <tr><td>Id</td></tr>
                         <tr><td><input type="text" name="id" maxlength="3" onKeyPress="if(event.keyCode<45 || event.keyCode>57) event.returnValue=false;"/></td></tr>
                         <tr><td>Nombre de Municipio</td></tr>
                         <tr><td><input type="text" name="municipio" maxlength="70" onKeyPress="if(!((event.keyCode>96 && event.keyCode<123) || (event.keyCode>64 && event.keyCode<91) || (event.keyCode==241 || event.keyCode==209 || event.keyCode==32))) event.returnValue=false;" /></td></tr>
                         <tr><td align="right"><input type="button" name="guardar" value="Guardar" /><input type="button" name="cancelar" value="Cancelar" /></td></tr>
               	</tbody>
	          </table>
          </form>
     </div>
	<div class="main-doc">
		...
		<div class="body">
			...
			<div class="colDer">
				...
				<p class="parrafo1">
					Cree, elimine y modifique Municipios.
	        	</p>
					...
					<table class="tbl-municipios" border="0" cellspacing="0">
						<tbody class="tbHead">
							<tr>
								...
								<th style="min-width:200px;">MUNICIPIO</th>
								<th>SELECCIONAR</th>
							</tr>
						</tbody>
						<tbody class="tbBody">
							<tr>
								<td class="no-data" colspan="3">Cargando...</td>
							</tr>
						</tbody>
						<tbody class="tbHide">
							<tr>
