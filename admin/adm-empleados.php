		...
		<form name="frmMunicipio" method="post">
			...
			<table>
				<tbody>
					...
					<tr><td><input type="text" name="apeP" /></td></tr>
					<tr><td>Apellido Materno</td></tr>
					<tr><td><input type="text" name="apeM" /></td></tr>
					<tr><td>Direccion</td></tr>
					<tr><td><input type="text" name="Direcc" /></td></tr>
					<tr><td>Profesion</td></tr>
					<tr><td><input type="text" name="Profes" /></td></tr>
					<tr><td>Telefono</td></tr>
					<tr><td><input type="text" name="Tel" /></td></tr>
	...
	<div class="main-doc">
		...
		<div class="body">
            ...
            tambien voy a poner aqui este otro mas.
				...
				<div>
					<table class="tbl-empleados" id="tbl-empleados">
						<tbody class="tbHead">
							<tr>
								<th>ID</th>
								<th>Nombre</th>
						...
						<tbody class="tbBody">
							<tr>
								<td colspan="11" class="loading">cargando...</td>
							</tr>
						</tbody>
					</table>
				</div>
