		...
		<form name="frmMunicipio" method="post">
			...
			<table>
				<tbody>
					...
					<tr><td><input type="text" name="apeM" maxlength="20" onKeyPress="if(!((event.keyCode>96 && event.keyCode<123) || (event.keyCode>64 && event.keyCode<91) || (event.keyCode==241 || event.keyCode==209 || event.keyCode==32))) event.returnValue=false;"  /></td></tr>
               ...
               Estos empleados pueden ser asignados como visitantes a un nucleo Agrario espefico.
				...
				<div>
					<table class="tbl-empleados" id="tbl-empleados" border="0" cellspacing="0">
						...
						<tbody class="tbBody">
							<tr>
								<td colspan="12" class="loading">cargando...</td>
							</tr>
						</tbody>
					</table>
				</div>
